...
This topic broadly falls under the area of __interpretable machine learning.__  Lots of papers and R packages (e.g. `ICEbox`) if you're interested!  
...
Boosting can work great, but it's more sensitive to these tuning parameters.  

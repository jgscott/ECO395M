...
This step can be related to Fourier analysis, where the eigenvectors of the Laplacian matrix correspond to the frequencies of the data. The smallest eigenvalues and their corresponding eigenvectors reveal the low-frequency structure of the data, which is used for clustering.
